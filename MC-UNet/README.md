...
![SA-UNet](others/SA-UNet.png?raw=true "SA-UNet")
...
### Training
Run [Train_drive.py](others/Train_drive.py)  or [Train_chase.py](others/Train_chase.py)
### Testing
Run [Eval_drive.py](others/Eval_drive.py) or [Eval_chase.py](others/Eval_chase.py)
